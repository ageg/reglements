...
\article{Préambule}
\alinea{L'AGEG Band est un groupe de l'AGEG dont l'objectif est de former à chaque session, un band de musique pour les activités sociales de l'AGEG.}

\article{Nomination des membres de l'AGEG Band}

\alinea{Les membres de l'AGEG Band sont nominés par le CA, deux sessions avant leur session d'activité, sous recommandation d'un comité de nomination dirigé par le VPAS.}

\alinea{Le comité de nomination des membres de l'AGEG Band est formé par le CA, sous recommandation du VPAS, et est constitué de deux personnes administratrices, du VPAS, du directeur de l'AGEG Band de la session en cours, d'un autre membre actif de l'AGEG Band et d'un ou plusieurs anciens membres de l'AGEG Band. Les membres du comité de nomination ne peuvent pas être candidat.}

\alinea{Le comité de nomination est responsable d'organiser une sélection ouverte à tous les membres de l'AGEG. Cette sélection doit être annoncé au moins 2 semaines à l'avance et une liste de chansons à apprendre doit être rendu disponible.}

\alinea{Le comité de nomination peut aussi faire des recommandations pour combler une formation incomplète. Pour ce faire, le comité doit aussi inclure au moins un membre de cette formation.}
...
\alinea{Un directeur AGEG Band est nommé parmis les membres de l'AGEG Band à chaque session pour faire la liaison entre l'AGEG Band et l'AGEG.}
\alinea{Le directeur AGEG Band est responsable de faire approuver les dépenses du groupe par le CA.}
\alinea{Le VPAS de l'AGEG est en charge de s'assurer de la bonne gestion de l'AGEG Band.}
\alinea{L'AGEG Band doit conserver une liste des évènements à lesquels il a participé ou prévoit participer à chaque session. L'AGEG Band doit participer à au moins 3 évènements par session.}
...
\alinea{La démission d’un membre de l’AGEG Band devra parvenir par écrit au VPAS .}
\alinea{Les membres de l'AGEG Band peuvent prendre la décision d'expulser un de leur membre, s'ils ont un motif valable. L'expulsion du membre doit être approuver par le VPAS.}