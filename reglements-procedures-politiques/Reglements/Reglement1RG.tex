...
\article{Quorum}
\alinea{Le quorum d'une assemblée générale régulière, annuelle ou spéciale est constitué de 2~\% des personnes membres régulières, tandis que celui pour une assemblée générale extroardinaire est de 10~\% . Il est nécessaire que le quorum subsiste pendant toute la durée de l’assemblée.}
...
\begin{itemize}
 ...
 \item Un total de \replace{douze (12)}{dix (10)} personnes administratrices saisonnières avec un (1) vote chacunes
 \begin{itemize}
